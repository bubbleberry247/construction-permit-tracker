...
■ 最新版のお知らせ（2026-05-18）
  本パッケージは Google Drive 経由ではなく、手渡し・ローカル配置でも
  そのまま利用できる最新版です。

  ・FDE_MANAGED/dashboard.xlsx
      会社別・書類別の確認用ダッシュボードです。
  ・FDE_MANAGED/00_一覧表_v3_20260518_郵送受領2社反映.xlsx
      今回反映後の一覧表です。審査・確認はこちらを正としてご利用ください。
  ・FDE_MANAGED/10_originals/
      会社別の原本 PDF 一式です。
  ・FDE_MANAGED/00_index/
      CSV 形式の台帳です。
...
■ このフォルダの構成
  協力会社書類管理/
    FDE_MANAGED/          ← FDE 管理領域。更新時は毎回丸ごと差し替え
      dashboard.xlsx
      00_一覧表_v3_20260518_郵送受領2社反映.xlsx
      manifest_sha256.txt
      00_index/
      10_originals/
